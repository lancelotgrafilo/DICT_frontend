import styleFocal from './focalSettings.module.css';

export function FocalSettings() {
  return (
    <div className={styleFocal.mainContent}>
      <h2>Personal Information</h2>
      <form className={styleFocal.configForm}>
        <div>
      ...
      <form className={styleFocal.passwordForm}>
        <div>
